...
<DiagramContainer title="Software-Defined Networking Architecture">

![SDN Architecture showing Network Controller, virtual networks, load balancers, and gateways](/microsoft-sovereign-cloud-brain-trek/images/level-200/sdn-architecture.svg)
