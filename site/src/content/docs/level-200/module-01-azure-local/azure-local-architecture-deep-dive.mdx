...
:::note
⏱️ **Reading Time:** 30-40 min | 🎯 **Key Topics:** S2D, SDN, cluster architecture, capacity planning | 📋 **Prerequisites:** [Azure Local Overview](/level-100/module-03-azure-local/azure-local-overview/)
:::
...
<DiagramContainer title="Storage Spaces Direct Architecture">

![Storage Spaces Direct (S2D) architecture showing storage pool, tiering, and resiliency layers](/microsoft-sovereign-cloud-brain-trek/images/level-200/storage-spaces-direct.svg)
...
- [Hardware Planning and Sizing](/level-200/azure-local-hardware-planning/) - Detailed hardware specifications and capacity calculations
- [High Availability Patterns](/level-200/azure-local-ha-patterns/) - Advanced HA/DR strategies and quorum options
- [Advanced Networking](/level-200/azure-local-advanced-networking/) - Network design, RDMA optimization, and QoS configuration
- [Knowledge Check](/level-200/azure-local-deep-dive-knowledge-check/) - Test your understanding with scenario-based questions
