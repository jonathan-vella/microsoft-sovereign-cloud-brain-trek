...
<DiagramContainer title="Security Patterns Matrix">

![Security Patterns Matrix showing compliance framework coverage across different security domains](/microsoft-sovereign-cloud-brain-trek/images/level-200/security-patterns-matrix.svg)
...
- **Main Module Topics:**
  - [GDPR Implementation & Data Residency](/level-200/gdpr-implementation/)
  - [FedRAMP Compliance Path](/level-200/fedramp-compliance/)
  - [Encryption & Key Management](/level-200/encryption-key-management/)
  - [Security Hardening Patterns](/level-200/module-05-compliance/security-hardening/)
