...
:::note
⏱️ **Reading Time:** 25-30 min | 🎯 **Key Topics:** LLM inference, vector databases, AKS Arc deployment | 📋 **Prerequisites:** [Edge RAG Concepts](/level-100/module-05-edge-rag/edge-rag-concepts/)
:::


:::tip[Preview Status]
Edge RAG, enabled by Azure Arc, is currently in **Preview**. Implementation details and APIs may change. Always refer to [official Microsoft documentation](https://learn.microsoft.com/en-us/azure/azure-arc/edge-rag/) for the latest guidance.
:::
...
**[Read: rag-deployment-strategies.md](/level-200/rag-deployment-strategies/)**
...
**[Read: vector-databases-edge.md](/level-200/module-03-edge-rag/vector-databases-edge/)**
...
**[Read: llm-inference-optimization.md](/level-200/llm-inference-optimization/)**
...
**[Read: rag-operations-monitoring.md](/level-200/rag-operations-monitoring/)**
...
**[Take the Knowledge Check: rag-implementation-knowledge-check.md](/level-200/rag-implementation-knowledge-check/)**
