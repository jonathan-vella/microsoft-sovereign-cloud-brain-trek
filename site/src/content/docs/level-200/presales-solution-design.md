...
- **Main Module Topics:**
  - [Customer Discovery & Requirements](/level-200/customer-discovery/)
  - [Solution Sizing & Planning](/level-200/module-04-presales/solution-sizing/)
  - [Cost Estimation & TCO](/level-200/cost-estimation/)
  - Proposal Development (covered in [Customer Discovery](/level-200/customer-discovery/) — see "Proposal writing" section)
  - [Knowledge Check](/level-200/presales-knowledge-check/)

- **Supporting Modules:**
  - [Edge RAG Implementation](/level-200/edge-rag-implementation/)
  - [Arc Advanced Management](/level-200/module-02-arc/arc-advanced-management/)
  - [Azure Local Architecture Deep Dive](/level-200/module-01-azure-local/azure-local-architecture-deep-dive/)
