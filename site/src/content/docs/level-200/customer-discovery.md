...
- **Solution Sizing:** [Solution Sizing & Planning](/level-200/module-04-presales/solution-sizing/)
- **Cost Analysis:** [Cost Estimation & TCO](/level-200/cost-estimation/)
- **Proposal Writing:** see [Customer Discovery](/level-200/customer-discovery/) and [Solution Sizing](/level-200/module-04-presales/solution-sizing/) for proposal inputs (dedicated proposal template forthcoming).
- **Assessment:** [Pre-Sales & Solution Design Knowledge Check](/level-200/presales-knowledge-check/)
