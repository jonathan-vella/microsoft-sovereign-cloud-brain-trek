...
:::note
⏱️ **Reading Time:** 25-30 min | 🎯 **Key Topics:** Key Vault, HSM, BYOK, key rotation, GDPR/FedRAMP | 📋 **Prerequisites:** [Security Compliance Basics](/level-50/module-02-security-compliance/security-compliance-basics/)
:::


## Overview

<DiagramContainer title="Encryption Key Hierarchy" defaultOpen>

![Encryption Key Hierarchy showing master keys, KEKs, DEKs and key rotation lifecycle](/microsoft-sovereign-cloud-brain-trek/images/level-200/encryption-key-hierarchy.svg)
...
- **Security:** [Security Hardening Patterns](/level-200/module-05-compliance/security-hardening/)
