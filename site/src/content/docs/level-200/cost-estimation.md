...
- **Discovery:** [Customer Discovery](/level-200/customer-discovery/)
- **Sizing:** [Solution Sizing & Planning](/level-200/module-04-presales/solution-sizing/)
- **Proposals:** combine [Customer Discovery](/level-200/customer-discovery/) findings with this cost worksheet (dedicated proposal template forthcoming).
