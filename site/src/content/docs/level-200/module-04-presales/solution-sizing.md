...
- **Proposals:** combine [Customer Discovery](/level-200/customer-discovery/) findings with [Cost Estimation](/level-200/cost-estimation/) outputs (dedicated proposal template forthcoming).
