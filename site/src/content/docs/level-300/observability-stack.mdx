...
<DiagramContainer title="Observability Stack">

![Observability Stack](/microsoft-sovereign-cloud-brain-trek/images/level-300/observability-stack.svg)
...
- **[Disaster Recovery →](/level-300/disaster-recovery/)** — Business continuity
- **[DevSecOps Pipeline →](/level-300/devsecops-pipeline/)** — Automated monitoring deployment
