...
<DiagramContainer title="Security Monitoring Flow">

![Security Monitoring Flow showing data collection, analysis, threat detection, and response pipeline](/microsoft-sovereign-cloud-brain-trek/images/level-300/security-monitoring-flow.svg)
...
1. Return to [Module Overview →](/level-300/zero-trust/)
2. Continue to [Module 2: Azure Local at Scale - Connected](/level-300/azure-local-advanced-connected/)
