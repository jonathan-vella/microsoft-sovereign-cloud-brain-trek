...
:::note
⏱️ **Reading Time:** 15-20 min | 🎯 **Key Topics:** Hybrid management, multi-cloud governance, Arc-enabled services | 📋 **Prerequisites:** [Azure Service Categories](/level-50/module-03-azure-intro/azure-service-categories/)
:::
...
<DiagramContainer title="Azure Arc Overview">
...
- [Review Digital Sovereignty →](/level-100/module-01-digital-sovereignty/digital-sovereignty/)
- [Review Operational Sovereignty →](/level-100/module-01-digital-sovereignty/operational-sovereignty/)
- [Review Azure Local (Sovereign Private Cloud) →](/level-100/module-03-azure-local/azure-local-overview/)
...
**[Learn More →](/level-100/module-04-azure-arc/azure-arc-servers/)**
...
**[Learn More →](/level-100/module-04-azure-arc/azure-arc-kubernetes/)**
...
**[Learn More →](/level-100/module-04-azure-arc/azure-arc-data-services/)**
...
:::note[📝 Source]
[Azure Arc Overview](https://learn.microsoft.com/en-us/azure/azure-arc/overview) — Microsoft Learn (November 2025)
:::
...
**[Learn More about Edge RAG →](/level-100/module-05-edge-rag/edge-rag-concepts/)**
...
:::note[📝 Source]
[Arc Resource Bridge Overview](https://learn.microsoft.com/en-us/azure/azure-arc/resource-bridge/overview) — Microsoft Learn (November 2025)
:::
...
:::caution[⚠️ Upgrade Requirement]
Arc Resource Bridge must be upgraded at least once every 6 months to maintain supportability. Plan regular maintenance windows for appliance updates.
:::
...
**[Review Operational Sovereignty Concepts →](/level-100/module-01-digital-sovereignty/operational-sovereignty/)**
...
### [Arc-Enabled Servers Deep Dive →](/level-100/module-04-azure-arc/azure-arc-servers/)
...
### [Arc-Enabled Kubernetes Deep Dive →](/level-100/module-04-azure-arc/azure-arc-kubernetes/)
...
### [Arc Data Services Overview →](/level-100/module-04-azure-arc/azure-arc-data-services/)
...
### [Azure Arc Knowledge Check Quiz →](/level-100/module-04-azure-arc/azure-arc-knowledge-check/)
