...
:::note[📝 Note]
Stretch clusters (cross-site synchronous replication) are not supported in Azure Local. For multi-site deployments, use Azure Site Recovery or Storage Replica between separate clusters.
:::
...
:::note[📝 Source]
[What is Microsoft 365 Local?](https://learn.microsoft.com/en-us/azure/azure-local/concepts/microsoft-365-local-overview) — Microsoft Learn (November 2025)
:::
...
- **[→ Next: National Partner Clouds](/level-100/module-02-cloud-models/national-partner-clouds/)**
- **[Explore: Operational Sovereignty Concepts](/level-100/module-01-digital-sovereignty/operational-sovereignty/)**
