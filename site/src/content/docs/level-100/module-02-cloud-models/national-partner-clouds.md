...
:::note[📝 Status]
Verify current availability and certification status with Microsoft France or partner websites, as this initiative may be in development or limited availability.
:::
...
:::note[📝 Status]
Verify current availability and service scope with Microsoft Germany or partner websites, as offerings may evolve.
:::
...
:::tip[📝 Note]
Many countries' sovereignty needs are now addressed through **Microsoft Cloud for Sovereignty** (Sovereign Public Cloud model) rather than dedicated partner clouds. This provides better service portfolio and faster innovation while still meeting sovereignty requirements.
:::
...
- **[← Back to Sovereign Cloud Models Overview](/level-100/module-02-cloud-models/sovereign-cloud-models/)**
- **[← Previous: Sovereign Private Cloud](/level-100/module-02-cloud-models/sovereign-private-cloud/)**
- **[← Previous: Sovereign Public Cloud](/level-100/module-02-cloud-models/sovereign-public-cloud/)**
- **[✅ Take the Quiz →](/level-100/module-02-cloud-models/cloud-models-knowledge-check/)**
