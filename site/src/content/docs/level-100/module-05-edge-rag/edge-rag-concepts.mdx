...
:::tip[Preview Status]
Edge RAG, enabled by Azure Arc, is currently in **Preview**. Features and availability may change before general availability. See [Supplemental Terms of Use for Microsoft Azure Previews](https://azure.microsoft.com/support/legal/preview-supplemental-terms/).
:::


:::note[📝 Source]
[What is Edge Retrieval Augmented Generation (RAG)?](https://learn.microsoft.com/en-us/azure/azure-arc/edge-rag/overview) — Microsoft Learn (November 2025)
:::
...
<DiagramContainer title="Edge RAG System Architecture" defaultOpen>
...
**[Learn About Azure Local →](/level-100/module-03-azure-local/azure-local-overview/)**
...
### [RAG Fundamentals Deep Dive →](/level-100/module-05-edge-rag/rag-fundamentals/)
...
### [RAG Use Cases and Implementation →](/level-100/module-05-edge-rag/edge-rag-use-cases/)
...
### [Edge RAG Knowledge Check Quiz →](/level-100/module-05-edge-rag/edge-rag-knowledge-check/)
