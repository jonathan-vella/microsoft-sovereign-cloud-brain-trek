...
<DiagramContainer title="Vector Embedding Process">

![Vector Embedding Process showing text to vector pipeline, semantic similarity, and model comparison](/microsoft-sovereign-cloud-brain-trek/images/level-100/vector-embedding-process.svg)
