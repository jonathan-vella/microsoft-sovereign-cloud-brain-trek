...
:::tip[Preview Status]
Edge RAG is currently in **Preview**. Architecture details and supported components may change. See [Microsoft Learn documentation](https://learn.microsoft.com/en-us/azure/azure-arc/edge-rag/) for the latest information.
:::
...
- [Edge RAG Use Cases →](/level-100/module-05-edge-rag/edge-rag-use-cases/)
- [RAG Fundamentals →](/level-100/module-05-edge-rag/rag-fundamentals/)
- [Edge RAG Quiz →](/level-100/module-05-edge-rag/edge-rag-knowledge-check/)
- [Back to Edge RAG Overview →](/level-100/module-05-edge-rag/edge-rag-concepts/)
