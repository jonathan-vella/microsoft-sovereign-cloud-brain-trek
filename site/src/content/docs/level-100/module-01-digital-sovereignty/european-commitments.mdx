...
:::note[📝 Source]
[What is the EU Data Boundary?](https://learn.microsoft.com/en-us/privacy/eudb/eu-data-boundary-learn) — Microsoft Learn (Updated September 2025)
:::


<DiagramContainer title="EU Data Boundary">

![EU Data Boundary](/microsoft-sovereign-cloud-brain-trek/images/level-100/eu-data-boundary.svg)
...
- **[Learn about Regulatory Requirements →](/level-100/module-01-digital-sovereignty/regulatory-overview/)**
