...
**[← Back to Azure Local Overview](/level-100/module-03-azure-local/azure-local-overview/)**
...
**Reference:** [Azure Arc Overview](/level-100/module-04-azure-arc/azure-arc-intro/)
...
:::caution[⚠️ Stretch Clusters Not Supported]
Azure Local does **not** support stretch clusters (single cluster spanning two sites). For multi-site high availability, use Azure Site Recovery or Storage Replica between separate Azure Local clusters at each site.
:::
...
- [Connected Mode Operations →](/level-100/module-03-azure-local/azure-local-connected-mode/)
- [Disconnected Mode Operations →](/level-100/module-03-azure-local/azure-local-disconnected-mode/)
- [Hardware Requirements & Planning →](/level-100/module-03-azure-local/azure-local-hardware/)
- [Azure Local Quiz →](/level-100/module-03-azure-local/azure-local-knowledge-check/)
