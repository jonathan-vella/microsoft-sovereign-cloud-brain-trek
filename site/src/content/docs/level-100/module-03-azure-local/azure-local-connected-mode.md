...
:::note
⏱️ **Reading Time:** 15-20 min | 🎯 **Key Topics:** Hybrid management, Azure Arc integration, outbound connectivity | 📋 **Prerequisites:** [Azure Local Overview](/level-100/module-03-azure-local/azure-local-overview/)
:::
...
**[Review Data Residency Concepts →](/level-100/module-01-digital-sovereignty/data-residency-concepts/)**
...
- [Azure Local Overview →](/level-100/module-03-azure-local/azure-local-overview/)
