...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-overview/#what-is-azure-local">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-disconnected-mode/#when-disconnected-mode-is-necessary">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-connected-mode/#data-sovereignty-in-connected-mode">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-hardware/#minimum-vs-recommended-specifications">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-architecture/#control-plane-vs-data-plane-separation">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-architecture/#rdma-remote-direct-memory-access">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-connected-mode/#prerequisites-and-connectivity-requirements">
...
<KnowledgeCheck answer="C" reference="/level-100/module-03-azure-local/azure-local-overview/#scenario-2-hospital-network-with-hipaa-compliance-connected-mode">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-architecture/#storage-resiliency">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-connected-mode/#cluster-aware-updating-cau">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-architecture/#encryption-at-rest">
...
<KnowledgeCheck answer="C" reference="/level-100/module-03-azure-local/azure-local-overview/#cost-considerations">
...
<KnowledgeCheck answer="C" reference="/level-100/module-03-azure-local/azure-local-disconnected-mode/#windows-admin-center">
...
<KnowledgeCheck answer="C" reference="/level-100/module-03-azure-local/azure-local-hardware/#storage-sizing-formula">
...
<KnowledgeCheck answer="B" reference="/level-100/module-03-azure-local/azure-local-architecture/#high-availability-design">
...
- Start from the beginning with [Azure Local Overview](/level-100/module-03-azure-local/azure-local-overview/)
...
- Review [Connected Mode Operations](/level-100/module-03-azure-local/azure-local-connected-mode/)
- Review [Disconnected Mode Operations](/level-100/module-03-azure-local/azure-local-disconnected-mode/)
- Focus on when to use each mode

**If you missed questions on data sovereignty (Q3, Q5):**

- Review [Data Sovereignty in Connected Mode](/level-100/module-03-azure-local/azure-local-connected-mode/#data-sovereignty-in-connected-mode)
- Review [Control Plane vs Data Plane](/level-100/module-03-azure-local/azure-local-architecture/#control-plane-vs-data-plane-separation)

**If you missed questions on hardware (Q4, Q6, Q14):**

- Review [Hardware Requirements](/level-100/module-03-azure-local/azure-local-hardware/)
- Review [Network Architecture](/level-100/module-03-azure-local/azure-local-architecture/#network-architecture)
- Review [Storage Resiliency](/level-100/module-03-azure-local/azure-local-architecture/#storage-resiliency)

**If you missed questions on use cases (Q8):**

- Review all [Customer Scenarios](/level-100/module-03-azure-local/azure-local-overview/#customer-scenarios)
- Consider real-world business requirements

**If you missed questions on operations (Q10, Q11, Q13, Q15):**

- Review [Update Procedures](/level-100/module-03-azure-local/azure-local-connected-mode/#update-and-patching-procedures)
- Review [Security Layers](/level-100/module-03-azure-local/azure-local-architecture/#security-layers-and-encryption)
- Review [High Availability](/level-100/module-03-azure-local/azure-local-architecture/#high-availability-design)
...
2. **📚 Continue to next module:**
   - [Azure Arc Introduction →](/level-100/module-04-azure-arc/azure-arc-intro/)

3. **🔗 Review related concepts:**
   - [Digital Sovereignty Fundamentals](/level-100/module-01-digital-sovereignty/digital-sovereignty/)
   - [Microsoft Sovereign Cloud Models](/level-100/module-02-cloud-models/sovereign-cloud-models/)
