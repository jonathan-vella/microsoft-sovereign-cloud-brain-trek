...
:::note
⏱️ **Reading Time:** 20-25 min | 🎯 **Key Topics:** Hyperconverged infrastructure, Azure hybrid, sovereign deployment | 📋 **Prerequisites:** [Cloud Computing Primer](/level-50/module-01-cloud-computing/cloud-computing-primer/)
:::
...
<DiagramContainer title="Azure Local in Sovereign Cloud Strategy" defaultOpen>
...
**[Review Digital Sovereignty Concepts →](/level-100/module-01-digital-sovereignty/digital-sovereignty/)**
...
:::note[📝 Source]
[Azure Local Scalability and Deployments](https://learn.microsoft.com/en-us/azure/azure-local/scalability-deployments) — Microsoft Learn (November 2025)
:::
...
:::tip[Preview Access]
Multi-rack deployments are available for qualified opportunities. Contact your Microsoft account team to participate.
:::
...
**[Learn More About Data Residency →](/level-100/module-01-digital-sovereignty/data-residency-concepts/)**
...
**[Explore Edge RAG Concepts →](/level-100/module-05-edge-rag/edge-rag-concepts/)**
...
:::tip[Partner Deployment Required]
Microsoft 365 Local must be deployed by a certified Microsoft 365 Local solution partner. Contact your Microsoft account team or visit [https://aka.ms/m365localsignup](https://aka.ms/m365localsignup).
:::
...
**[Deep Dive: Hardware Requirements →](/level-100/module-03-azure-local/azure-local-hardware/)**
...
**[Deep Dive: Network Architecture →](/level-100/module-03-azure-local/azure-local-architecture/)**
...
### [Azure Local Architecture Deep Dive](/level-100/module-03-azure-local/azure-local-architecture/)
...
### [Azure Local Knowledge Check Quiz →](/level-100/module-03-azure-local/azure-local-knowledge-check/)
...
3. **✅ Explore Related Modules**
   - [Digital Sovereignty Fundamentals](/level-100/module-01-digital-sovereignty/digital-sovereignty/) - Core concepts
   - [Microsoft Sovereign Cloud Models](/level-100/module-02-cloud-models/sovereign-cloud-models/) - Model comparison
   - [Azure Arc Introduction](/level-100/module-04-azure-arc/azure-arc-intro/) - Hybrid management

4. **🎯 Continue to Next Module**
   - [Azure Arc Introduction →](/level-100/module-04-azure-arc/azure-arc-intro/) - Learn how Arc extends Azure management
