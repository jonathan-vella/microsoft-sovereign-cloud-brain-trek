...
<DiagramContainer title="Authentication vs Authorization Flow">

![Authentication vs Authorization Flow](/microsoft-sovereign-cloud-brain-trek/images/level-50/authentication-authorization-flow.svg)
...
Complete the [Security & Compliance Knowledge Check](/level-50/module-02-security-compliance/security-compliance-knowledge-check/) to test your understanding.
