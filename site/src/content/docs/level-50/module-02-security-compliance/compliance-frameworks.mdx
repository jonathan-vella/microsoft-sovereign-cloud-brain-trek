...
<DiagramContainer title="Major Compliance Framework Timeline">

![Regulatory Timeline](/microsoft-sovereign-cloud-brain-trek/images/level-100/regulatory-timeline.svg)
...
Review [Identity and Access Basics](/level-50/module-02-security-compliance/identity-access-basics/) for access control fundamentals.
