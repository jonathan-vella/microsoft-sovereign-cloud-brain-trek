...
<DiagramContainer title="The CIA Triad">

![CIA Triad showing Confidentiality, Integrity, and Availability](/microsoft-sovereign-cloud-brain-trek/images/level-50/cia-triad.svg)
...
<DiagramContainer title="Defense in Depth Layers">

![Defense in Depth showing 7 security layers](/microsoft-sovereign-cloud-brain-trek/images/level-50/defense-in-depth.svg)
...
<DiagramContainer title="Compliance Frameworks Comparison">

![Compliance Frameworks showing GDPR, HIPAA, SOC 2, PCI DSS, FedRAMP, and ISO 27001 comparison](/microsoft-sovereign-cloud-brain-trek/images/level-50/compliance-frameworks-comparison.svg)
...
3. ✅ Continue to [Data Protection Principles](/level-50/module-02-security-compliance/data-protection-principles/)
4. ✅ Study [Compliance Frameworks](/level-50/module-02-security-compliance/compliance-frameworks/)
5. ✅ Review [Identity and Access Basics](/level-50/module-02-security-compliance/identity-access-basics/)
6. ✅ Complete [Module 2 Knowledge Check](/level-50/module-02-security-compliance/security-compliance-knowledge-check/)
