...
<DiagramContainer title="Cloud Deployment Architectures">

![Cloud Deployment Models showing Public, Private, Hybrid, and Multi-cloud architectures](/microsoft-sovereign-cloud-brain-trek/images/level-50/cloud-deployment-models.svg)
_Figure 1: Cloud deployment model architectures and their relationships_

</DiagramContainer>

<DiagramContainer title="Cloud Deployment Models Overview">

![Cloud Deployment Models Overview](/microsoft-sovereign-cloud-brain-trek/images/level-50/cloud-deployment-models-overview.svg)
...
3. ✅ Continue to [Cloud Benefits and Considerations](/level-50/module-01-cloud-computing/cloud-benefits/)
4. ✅ Complete the [Knowledge Check](/level-50/module-01-cloud-computing/cloud-computing-knowledge-check/) after all Module 1 content
