...
<DiagramContainer title="Shared Responsibility Matrix (Visual)">

![Shared Responsibility Matrix showing customer vs provider responsibilities across IaaS, PaaS, and SaaS](/microsoft-sovereign-cloud-brain-trek/images/level-50/shared-responsibility-matrix.svg)
_Figure 1: Shared Responsibility Matrix across cloud service models_

</DiagramContainer>

<DiagramContainer title="Shared Responsibility Model (Table)">
...
![Shared Responsibility Shift](/microsoft-sovereign-cloud-brain-trek/images/level-50/shared-responsibility-shift.svg)
...
3. ✅ Continue to [Cloud Deployment Models](/level-50/module-01-cloud-computing/cloud-deployment-models/)
