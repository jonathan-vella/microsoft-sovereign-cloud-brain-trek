...
**Time Limit:** None
**Attempts:** Unlimited for learning purposes
...
**A)** Physical servers and networking hardware
**B)** Hypervisor and virtualization layer
...
**Explanation:**
In IaaS, the cloud provider manages the physical infrastructure, hypervisor, and data center facilities. The customer is responsible for:
...
**A)** Public cloud is free, private cloud costs money
**B)** Public cloud uses shared infrastructure, private cloud uses dedicated infrastructure
...
**Explanation:**
**Hybrid cloud** specifically refers to combining public and private cloud environments with integration between them. This allows organizations to:
...
**A)** The ability to recover from failures quickly
...
**Explanation:**
**Elasticity** is the ability to automatically provision and release resources to match workload demands. This means:
...
**Explanation:**
**Microsoft 365** is a complete SaaS solution providing ready-to-use applications like Word, Excel, PowerPoint, and Teams accessed through a web browser or installed applications.
...
**A)** Cloud computing is always more expensive
**B)** Traditional IT uses OpEx, cloud computing uses CapEx
...
**Explanation:**
**On-demand self-service** is the NIST cloud characteristic that allows users to:
...
**Explanation:**
The primary advantage of multi-cloud is **avoiding vendor lock-in** by:
...
**B)** Data sensitivity and compliance requirements
...
**Explanation:**
**Data sensitivity and compliance requirements** are the most critical factors because they determine:
...
**90-100% (Excellent)**
You have demonstrated strong understanding of cloud computing fundamentals. You're ready to proceed to more advanced topics.

**80-89% (Good)**
You have solid grasp of the concepts with minor knowledge gaps. Review any missed questions and proceed to the next module.

**60-79% (Adequate)**
You understand basic concepts but should review the material before proceeding. Focus on areas where you missed questions.

**Below 60% (Needs Improvement)**
Consider reviewing all Module 1 content before proceeding. Focus on understanding the fundamental differences between service models and deployment models.
...
2. ✅ Proceed to [Module 2: Security & Compliance Fundamentals](security-compliance-basics.md)
3. ✅ Continue with Level 50 learning path

### For Scores Below 80%

1. ✅ Review [Cloud Computing Primer](cloud-computing-primer.md)
2. ✅ Study [Cloud Service Models](cloud-service-models.md) in detail
3. ✅ Review [Cloud Deployment Models](cloud-deployment-models.md)
4. ✅ Read [Cloud Benefits and Considerations](cloud-benefits.md)
5. 🔄 Retake this knowledge check
...
- [Microsoft Learn: Cloud Concepts](https://learn.microsoft.com/en-us/training/modules/principles-cloud-computing/)
