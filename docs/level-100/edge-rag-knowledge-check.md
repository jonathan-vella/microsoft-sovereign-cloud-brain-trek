...
nav_order: 5.4
description: "Knowledge check covering Edge RAG (preview) concepts — RAG fundamentals, on-premises deployment via Azure Arc-enabled Kubernetes, ingestion and retrieval pipelines, and sovereign-cloud use cases."
---
...
**Reference:** [Traditional LLMs vs. RAG](edge-rag-concepts.md#traditional-llms-vs-rag-augmented-systems)
</details>
...
**Reference:** [RAG Fundamentals](rag-fundamentals.md#traditional-llms-and-their-limitations)
</details>
...
**Reference:** [Edge RAG Benefits](edge-rag-concepts.md#edge-rag-definition-and-benefits)
</details>
...
**Explanation:**
Embeddings are dense numerical vectors (for example, 384 or 1536 dimensions) that represent text in a way that captures semantic meaning. Similar meanings result in similar vectors, enabling semantic search. They're not images, hyperlinks, or metadata, though embeddings can be generated from any of these.

**Reference:** [Embedding Models](rag-fundamentals.md#embedding-models-and-representation-learning)
</details>
...
**Reference:** [Vector Databases](rag-fundamentals.md#vector-databases-and-similarity-search)
</details>
...
**Reference:** [Data Sovereignty](edge-rag-concepts.md#connection-to-sovereign-cloud-strategies)
</details>
...
**Reference:** [RAG Architecture](edge-rag-architecture.md#data-ingestion-and-indexing-pipeline)
</details>
...
**Reference:** [Customer Scenarios](edge-rag-concepts.md#scenario-1-healthcare-documentation-assistant-disconnected-edge)
</details>
...
**Reference:** [Fine-Tuning vs. RAG](rag-fundamentals.md#fine-tuning-vs-rag-trade-offs)
</details>
...
**Reference:** [RAG Fundamentals](rag-fundamentals.md#evaluation-metrics-for-rag-systems)
</details>
...
**Reference:** [Why RAG for Enterprise](edge-rag-concepts.md#why-rag-for-enterprise-applications)
</details>
...
**Reference:** [Hardware Requirements](edge-rag-architecture.md#hardware-requirements)
</details>
...
**Reference:** [Scenario 4: Research Lab](edge-rag-concepts.md#scenario-4-research-lab-data-analysis-hybrid)
</details>
...
**Reference:** [ROI and Business Value](edge-rag-use-cases.md#roi-and-business-value)
</details>
...
- Start from the beginning with [Edge RAG Concepts](edge-rag-concepts.md)
...
- Review [Edge RAG Concepts](edge-rag-concepts.md)
- Review [RAG Fundamentals](rag-fundamentals.md)

**If you missed questions on deployment (Q3, Q6, Q13, Q14):**

- Review [Edge RAG Architecture](edge-rag-architecture.md)
...
- Review [Edge RAG Use Cases](edge-rag-use-cases.md)
- Review customer scenarios in [Edge RAG Concepts](edge-rag-concepts.md)
...
2. **📚 Review other Level 100 modules if needed:**
   ...
   - [Sovereign Cloud Models](sovereign-cloud-models.md)
...
**[← Back to Edge RAG Concepts](edge-rag-concepts.md)**
