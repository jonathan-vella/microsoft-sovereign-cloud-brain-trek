...
nav_order: 3.5
description: "Knowledge check covering Azure Local foundations — architecture, hardware planning, and connected vs disconnected operational modes."
---
...
**Reference:** [Azure Local Overview](azure-local-overview.md#what-is-azure-local)
</details>
...
**Reference:** [Disconnected Mode Operations](azure-local-disconnected-mode.md#when-disconnected-mode-is-necessary)
</details>
...
**Reference:** [Connected Mode Operations](azure-local-connected-mode.md#data-sovereignty-in-connected-mode)
</details>
...
**Reference:** [Hardware Requirements](azure-local-hardware.md#minimum-vs-recommended-specifications)
</details>
...
**Reference:** [Architecture Deep Dive](azure-local-architecture.md#control-plane-vs-data-plane-separation)
</details>
...
**Reference:** [Network Architecture](azure-local-architecture.md#rdma-remote-direct-memory-access)
</details>
...
**Reference:** [Connected Mode Prerequisites](azure-local-connected-mode.md#prerequisites-and-connectivity-requirements)
</details>
...
**Reference:** [Customer Scenarios](azure-local-overview.md#scenario-2-hospital-network-with-hipaa-compliance-connected-mode)
</details>
...
**Reference:** [Storage Resiliency](azure-local-architecture.md#storage-resiliency)
</details>
...
**Reference:** [Update Procedures](azure-local-connected-mode.md#cluster-aware-updating-cau)
</details>
...
**Reference:** [Security Layers](azure-local-architecture.md#encryption-at-rest)
</details>
...
**Reference:** [Cost Considerations](azure-local-overview.md#cost-considerations)
</details>
...
**Reference:** [Management Without Cloud Connection](azure-local-disconnected-mode.md#windows-admin-center)
</details>
...
**Reference:** [Storage Sizing](azure-local-hardware.md#storage-sizing-formula)
</details>
...
**Reference:** [High Availability Design](azure-local-architecture.md#high-availability-design)
</details>
...
- Start from the beginning with [Azure Local Overview](azure-local-overview.md)
...
- Review [Connected Mode Operations](azure-local-connected-mode.md)
- Review [Disconnected Mode Operations](azure-local-disconnected-mode.md)
- Focus on when to use each mode

**If you missed questions on data sovereignty (Q3, Q5):**

- Review [Data Sovereignty in Connected Mode](azure-local-connected-mode.md#data-sovereignty-in-connected-mode)
- Review [Control Plane vs Data Plane](azure-local-architecture.md#control-plane-vs-data-plane-separation)

**If you missed questions on hardware (Q4, Q6, Q14):**

- Review [Hardware Requirements](azure-local-hardware.md)
- Review [Network Architecture](azure-local-architecture.md#network-architecture)
- Review [Storage Resiliency](azure-local-architecture.md#storage-resiliency)

**If you missed questions on use cases (Q8):**

- Review all [Customer Scenarios](azure-local-overview.md#customer-scenarios)
- Consider real-world business requirements

**If you missed questions on operations (Q10, Q11, Q13, Q15):**

- Review [Update Procedures](azure-local-connected-mode.md#update-and-patching-procedures)
- Review [Security Layers](azure-local-architecture.md#security-layers-and-encryption)
- Review [High Availability](azure-local-architecture.md#high-availability-design)
...
2. **📚 Continue to next module:**
   - [Azure Arc Introduction →](azure-arc-intro.md)

3. **🔗 Review related concepts:**
   - [Digital Sovereignty Fundamentals](digital-sovereignty.md)
   - [Microsoft Sovereign Cloud Models](sovereign-cloud-models.md)
